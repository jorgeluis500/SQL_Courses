...
-- Insert another column in the products table
...
-- Completing the customers and orders tables
...
-- Inserting rows into products. This sections is repeated in the " Inserting, updating and deleting rows"  file
